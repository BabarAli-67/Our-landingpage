...
/* ------------------------------------------------------------------ */
/*  CLIENT REVIEWS — Fiverr + direct (company attribution only)       */
/* ------------------------------------------------------------------ */
export const clientReviews = [
  {
    ...
    rating: 5,
    quote:
      'Nexus Dev Studio delivered excellent work! Fixed all Flutter bugs quickly and efficiently. Clean code, great communication, and fast delivery. Highly recommended!',
  },
  {
    id: 'r2',
    ...
    rating: 5,
    quote:
      'Great experience working with Nexus Dev Studio from start to finish. We only had a rough idea for our app, but they took the time to understand our requirements and turned it into a clean, professional design concept. The whole process was smooth — quick responses, regular updates on progress, and the final delivery matched exactly what we had in mind. The attention to detail in the UI was impressive for the price point too. Will definitely be working with them again on future projects!',
  },
  {
    id: 'r3',
    company: 'Rhein Softworks',
    role: 'Germany',
    source: 'fiverr',
    rating: 5,
    quote:
      'Great experience working with Nexus Dev Studio from start to finish. We had a design ready for our app but needed someone to bring it to life, and they did exactly that. They understood our visuals quickly and converted them into a fully functional Flutter app with smooth navigation and proper working logic behind every screen — not just a UI copy, but the real thing. The whole process was smooth, with quick responses and regular updates on progress. They were also fair and open when discussing the scope and pricing. Really impressed with the quality for the price point, and we’ll definitely be coming back for future projects!',
  },
  {
    id: 'r4',
    ...
    quote:
      'Working with Nexus Dev Studio has been an excellent experience. The team is highly professional, knowledgeable, and committed to delivering high-quality work. They understand requirements well, communicate effectively, and always go the extra mile to ensure the project is completed successfully. We highly recommend them for any software development project.',
  },
];
...
export const processSteps = [
  { icon: MessagesSquare, title: 'Message us', body: 'Tell us what you need — website, app, or both — on WhatsApp.' },
  { icon: Rocket, title: 'Discovery', body: 'We map goals, scope, and the fastest path to a shippable release.' },
  { icon: Code2, title: 'Build & demo', body: 'Weekly demos, tight loops, production from the first sprint.' },
  { icon: ShieldCheck, title: 'Launch', body: 'Store / web launch, hardening, and a team that stays after go-live.' },
];
...
export const whyUs = [
  {
    icon: Globe2,
    title: 'Web + apps under one roof',
    body: 'One team for websites and mobile apps — aligned design, shared stack, no juggling two freelancers.',
  },
  {
    icon: Users,
    title: 'Small senior team',
    body: 'Specialists who’ve shipped at scale, working directly with you — no account-manager telephone game.',
  },
  {
    icon: GitBranch,
...
/* ------------------------------------------------------------------ */
/*  LANDING — Web Development projects (best 3)                       */
/* ------------------------------------------------------------------ */
export const webProjects = [
  {
    id: 'vertex',
    title: 'Vertex Platform',
    result: '0.4s median TTFB',
    summary:
      'High-traffic SaaS on Next.js + edge rendering — design system, global loads, production-ready DX.',
    image:
  ...
  },
  {
    ...
    result: '+38% pipeline velocity',
    summary:
      'Ground-up web CRM replacing three tools, with lead scoring and reporting baked into the pipeline.',
    image:
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=70',
  ...
  },
  {
    ...
    result: '71% tickets auto-resolved',
    summary:
      'Customer-facing web portal with RAG over 40k docs and human-in-the-loop escalation.',
    image:
      'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1200&q=70',
...
/* ------------------------------------------------------------------ */
/*  LANDING — App Development projects (best 3)                       */
/* ------------------------------------------------------------------ */
export const appProjects = [
  ...
  },
  {
    ...
    summary:
      'Cross-platform scheduling with a shared codebase and physics-driven motion.',
    image:
  ...
  },
  {
    ...
    result: '1,200 hrs/mo saved',
    summary:
      'Field ops companion app — offline checklists, photo capture, and live sync for on-site teams.',
    image:
