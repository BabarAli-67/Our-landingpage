...
export const siteConfig = {
  ...
  description:
    'Nexus Dev Studio is a two-person studio that takes a business problem — slow website, no app, a broken process — and ships the fix. One team, start to finish.',
  ...
  nav: [
    { label: 'Work', href: '/#web' },
    { label: 'How We Solve It', href: '/#apps' },
